...
data_2008 <- loop_over_year(2008)
data_2009 <- loop_over_year(2009)
data_2010 <- loop_over_year(2010)

## Write data into file.
write.csv(data_2008,
          file.path(pr_results, "aggregated_gridmet_2008.csv"),
          row.names = FALSE)

write.csv(data_2009,
          file.path(pr_results, "aggregated_gridmet_2009.csv"),
          row.names = FALSE)

write.csv(data_2010,
          file.path(pr_results, "aggregated_gridmet_2010.csv"),
          row.names = FALSE)
