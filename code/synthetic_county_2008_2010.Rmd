...
merged_obj$missing <- as.factor(ifelse(is.na(merged_obj$mean_bmi), 1, 0))
...
brfss_data$mean_bmi <- ifelse(brfss_data$mean_bmi == 9999, NA,
                              brfss_data$mean_bmi)
...
spplot(merged_obj, zcol = "mean_bmi",
       col.regions=heat.colors(51, rev = TRUE),
       xlab="Longitude", ylab="Latitude",
...
spplot(merged_obj, zcol = "mrtlty_cms_pct",
       col.regions=heat.colors(51, rev = TRUE),
       xlab="Longitude", ylab="Latitude",
